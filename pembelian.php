...
<head>
    ...
    <link rel="stylesheet" href="style.css"> <!-- Ganti style.css dengan nama file CSS Anda -->
</head>
<body>
...
<form action="proses_pembelian.php" method="post">
    ...
    <!-- Input lainnya sesuai kebutuhan (toko, user, suplier, dll) -->
    ...
    <table id="detail_pembelian">
        ...
        <!-- Baris tambahan untuk input produk -->
    </table><br>
