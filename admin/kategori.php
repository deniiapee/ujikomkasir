                                                ...
                                                <table class="table" style="width:100%;height: 100%">
                                                    ...
                                                    if ($result) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>
                                                <a href='Edit/edit_kategori.php?id=" . $row['kategori_id'] . " 'class='btn btn-sm btn-primary'>Edit</a>
                                                <a href='Delete/delete_kategori.php?id=" . $row['kategori_id'] . " 'class='btn btn-sm' style='background-color:#FF4646; color:#fff'>Hapus</a>
                                            </td>";
