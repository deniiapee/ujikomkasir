...
if ($_SESSION["username"]) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Pastikan array key telah di-set sebelum mengaksesnya
        $produk_id = isset($_POST["produk_id"]) ? $_POST["produk_id"] : null;
        $jumlah_keluar = isset($_POST["jumlah_keluar"]) ? $_POST["jumlah_keluar"] : null;

        // Lanjutkan hanya jika kedua variabel telah di-set
        if ($produk_id !== null && $jumlah_keluar !== null) {
            ...
            $sql = "INSERT INTO stock (produk_id, jumlah_masuk) VALUES (?, ?)";
            ...
            if ($stmt) {
                ...
                $stmt->bind_param("ii", $produk_id, $jumlah_masuk);
                ...
                // Jika statement tidak berhasil dibuat, tampilkan pesan error
            ...
            // Jika kedua variabel tidak di-set, tampilkan pesan error
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Stock Barang Keluar</h1>
                            ...
                            <div class="table-responsive">
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlah_keluar" id="jumlah_keluar" placeholder="Jumlah Keluar" required>
                                    </div>
