        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="registrasi/registrasi_pelanggan.php">
                        <button type="button" class="btn btn-primary" style="margin-left:80%;margin-bottom:10px;">Tambah Pelanggan</button>
                    </a>
                                                ...
                                                <table class="table" style="width:100%;height: 100%">
                                                    ...
                                                    if ($result) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>
                                                <a href='Edit/edit_pelanggan.php?id=" . $row['pelanggan_id'] . " 'class='btn btn-sm btn-primary'>Edit</a>
