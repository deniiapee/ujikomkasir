...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="log.php">Login</a>
            ...
            <!-- Nav Item - regristeasi -->
            <li class="nav-item">
                <a class="nav-link" href="registrasi/registrasi_pengguna.php">
      ...
      <div class="form-grup" id="perpustakaan-container">
        ...
        <div class="form-grup">
            ...
            <select name="role" class="form-control" required>
                ...
                <option value="Adminitrasi">Admin</option>
            </select>
        </div>
        <div class="form-grup d-flex" style="margin-left: 40px;">
        <a href="../pengguna.php"><button type="button" class="btn btn-secondary mt-4">Close</button></a>
        <button type="submit" name="registrasi" class="btn btn-info mt-4 ml-2">Registrasi</button>
        </div>
    </form>
