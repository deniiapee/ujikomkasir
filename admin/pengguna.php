...
session_start();
$sql = "SELECT user.*, toko.nama_toko  FROM user INNER JOIN toko ON user.toko_id=toko.toko_id;";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="registrasi/registrasi_pengguna.php">
                        <button type="button" class="btn btn-primary" style="margin-left:80%;margin-bottom:10px;">Tambah Pengguna</button>
                    </a>
                                        ...
                                        <div class="content shadow p-3 mb-5 bg-body-tertiary rounded" style="width:100%;height: 400px;; background-color:white;">
                                            <div class="container d-flex" style="position:relative; width:100%;">
                                                <table class="table" style="width:100%;height: 100%">
                                                    <?php
                                                    echo "<thead><th>No</th><th>username</th><th>Email</th><th>Nama Lengkap</th><th>Alamat</th><th>Role</th><th>Aksi</th></thead>";
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo "<td>" . $row["role"] . "</td>";
                                                            echo "<td>
                                                <a href='Edit/edit_pengguna.php?id=" . $row['user_id'] . " 'class='btn btn-sm btn-primary'>Edit</a>
                                                <a href='Delete/delete_pengguna.php?id=" . $row['user_id'] . " 'class='btn btn-sm' style='background-color:#FF4646; color:#fff'>Hapus</a>
                                            </td>";
